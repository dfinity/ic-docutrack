...
export type download_file_response = { 'found_file' : Uint8Array } |
...
export interface file_metadata { 'file_name' : string, 'file_id' : file_id }
...
export interface _SERVICE {
  ...
  'upload_file' : ActorMethod<[file_id, Uint8Array], upload_file_response>,
