...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${principalValue ? `${validate_component(RequestModal, "RequestModal").$$render($$result, { isOpen: false }, {}, {})}
	<br>
	${validate_component(ContentTable, "ContentTable").$$render($$result, { columns: tableColumns, data: tableData }, {}, {})}` : `${validate_component(Alert, "Alert").$$render($$result, { color: "warning" }, {}, {
    default: () => {
