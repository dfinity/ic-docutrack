...
export type get_alias_info_response =
	...
	| { Err: { not_found: null } };
export type get_users_response = { permission_error: null } | { users: Array<user_data> };
...
export type upload_file_error = { not_requested: null } | { already_uploaded: null };
...
export interface _SERVICE {
	...
	upload_file: ActorMethod<[file_id, Uint8Array, Uint8Array], upload_file_response>;
